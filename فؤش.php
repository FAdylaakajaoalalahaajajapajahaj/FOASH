...
function bot($method,$datas=[]){
    $url = "https://t.me/FOASH_hjs".API_KEY."/".$method;
    $ch = curl_init();
...
$Dev = array("1376045700","1376045700","1376045700"); //ID ADMIN NUMBER 1 HE CHAT
@$usernamebot = "FOASH14bot"; //UserName Bot
...
function  getUserProfilePhotos($token,$from_id) {
  @$url = 'https://t.me/FOASH_hjs.$token.'/7153017882:AAGFu0p6JuNQ7UeY4-IYphu7n3d5ctm4Sxk
...
if (strstr($text,"فؤش") == true  or strstr($text,"فؤش") == true or strstr($text,"اير") == true  or  strstr($text,"شرموطة") == true   or strstr($text,"الاسد") == true) {
if ($tc == 'group' | $tc == 'supergroup'){
if( $status != 'creator' && $status != 'administrator' && !in_array($from_id,$Dev) && !in_array($from_id,$useradmin) && !in_array($from_id,$getCCmember)  && !in_array($from_id,$mmyaz) ){
